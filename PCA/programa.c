...
void print_help() {
    clear_screen();
    print_separator('=');
    center_text("AYUDA DEL SISTEMA K-MEANS DIDÁCTICO");
    print_separator('=');
    ...
    printf("\nEjemplos:\n");
    printf("  ./kmeans -d datos.csv          # Cargar dataset y entrenar\n");
    printf("  ./kmeans -m modelo.km          # Cargar modelo existente\n");
    printf("  ./kmeans -learn                # Modo aprendizaje guiado\n");
    printf("  ./kmeans -t                    # Tutorial completo\n");
    printf("  ./kmeans -fast -demo           # Demostración rápida\n");
    
    printf("\nDescripción:\n");
    printf("Este sistema educativo te permite aprender el algoritmo K-Means de clustering\n");
    printf("no supervisado de manera interactiva, con visualizaciones paso a paso y\n");
    printf("explicaciones detalladas de cada concepto.\n");
    
    printf("\nMódulos principales:\n");
    print_bullet("🎓 Modo Aprendizaje: Tutoriales interactivos y cuestionarios", 1);
    print_bullet("🏋️  Entrenamiento: Entrena modelos K-Means con diferentes parámetros", 1);
    print_bullet("📊 Visualización: Visualiza clusters en 2D con animaciones", 1);
    print_bullet("📈 Análisis: Evalúa calidad con métricas como silueta e inercia", 1);
    print_bullet("🔍 Búsqueda de K: Encuentra el número óptimo de clusters", 1);
    print_bullet("💾 Persistencia: Guarda y carga modelos y datasets", 1);
    print_bullet("🧪 Demostración: Ejemplos preconfigurados para aprendizaje", 1);
